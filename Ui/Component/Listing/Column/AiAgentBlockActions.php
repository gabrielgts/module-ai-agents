 ...
 */
class AiAgentBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'AiAgent';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'ai_agent/aiagent/edit';
    private const DELETE_URL_PATH = 'ai_agent/aiagent/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[AiAgentInterface::ENTITY_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [AiAgentInterface::ENTITY_ID => $item[AiAgentInterface::ENTITY_ID]];
