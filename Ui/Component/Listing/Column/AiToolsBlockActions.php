...
namespace Gtstudio\AiAgents\Ui\Component\Listing\Column;
 ...
 */
class AiToolsBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'AiTools';

    /**
     * Url paths.
     */
    private const EDIT_URL_PATH = 'ai_tools/aitools/edit';
    private const DELETE_URL_PATH = 'ai_tools/aitools/delete';
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[AiToolsInterface::ENTITY_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [AiToolsInterface::ENTITY_ID => $item[AiToolsInterface::ENTITY_ID]];
